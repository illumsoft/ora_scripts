...
(
  runid           number constraint plsql_profiler_runs_pk primary key,  -- unique run identifier,
...
(
  ...
  --
  constraint plsql_profiler_units_pk
...
(
  ...
  --
  constraint plsql_profiler_data_pk
    primary key (runid, unit_number, line#),
  constraint plsql_profiler_data_fk
